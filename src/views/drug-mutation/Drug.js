...
const TABLE_HEAD = [
  ...
  { id: "drug_unit_id", label: "Satuan Obat", alignRight: false },
...
export default function Drug() {
  ...
  //   const response = await axios.get(endpoint.drug.option_mutation, {
  //     params: params,
  //   });
  ...
  const getData = async (newPage, newRowsPerPage) => {
    ...
    const response = await axios.get(endpoint.drug_mutation.root, {
      params: params,
    });
    if (response && response.data) {
  ...
  const getExport = async (exportType) => {
    ...
    const params = { ...filter };
    const response = await axios.get(endpoint.drug_mutation.export, {
      params: params,
    });
    if (exportType) {
      downloadFile(endpoint.drug_mutation.export, exportType, params);
    }
    if (response) {
  ...
  const downloadFile = async (url, drug_mutation, params) => {
    await axios
      .get(url, {
        params: params,
        responseType: "blob",
      ...
      .then((rsp) => {
        ...
        link.href = url;
        link.setAttribute("download", "recap_drug_mutation.xlsx"); //or any other extension
  ...
  //     ids: selectedIds,
  //   };
  //   const response = await axios.delete(endpoint.drug_name.delete, {
  //     data: params,
  //   });
  //   if (response) {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* <TableCell align="left">
                          {drugname && drugdistribution.drugname.drug_name}
                        </TableCell>
                        <TableCell align="left">
                          {listofukslocations &&
                            drugdistribution.locationdrug.listofukslocations
                              .uks_name}
                        </TableCell> */}
                      <TableCell align="left">
