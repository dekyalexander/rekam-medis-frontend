...
import SchoolListToolbar from './SchoolListToolbar';
...
const TABLE_HEAD = [
  ...
  { id: 'head_master', label: 'Head Master', alignRight: false },
];
...
export default function School() {
  ...
  const getData = async () => {
    const response = await axios.get(endpoint.school.root);
  ...
  const handleDelete = async () => {
    ...
    const response = await axios.delete(endpoint.school.root, {
      data: params
    });
    if (response) {
              ...
              <Table>
                ...
                <TableBody>
                  {filteredData
                    ...
                    .map((row) => {
                      const { id, name, code, jenjang, head_employee } = row;
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="left">{head_employee&&head_employee.name}</TableCell>
