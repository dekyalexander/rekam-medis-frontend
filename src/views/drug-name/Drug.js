...
const TABLE_HEAD = [
  { id: "drug_kode", label: "Kode Obat", alignRight: false },
  { id: "drug_name", label: "Nama Obat", alignRight: false },
...
function applySortFilter(array, comparator, query) {
  ...
  if (query) {
    return filter(
      array,
      (_user) =>
        _user.drug_name.toLowerCase().indexOf(query.toLowerCase()) !== -1
    );
  }
            ...
            <Table>
              ...
              <TableBody>
                {filteredData
                  ...
                  .map((row) => {
                    const { id, drug_kode, drug_name, created_at } = row;
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">{drug_name}</TableCell>
