...
export default function Role() {
  ...
  const getData = async () => {
    const response = await axios.get(endpoint.role.root);
            ...
            <TableContainer sx={{ minWidth: 800 }}>
              <Table>
                ...
                <TableBody>
                  {filteredData
                    .map((row) => {
                      const { id, name, code, unit, data_access, is_head, head_role} = row;
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="left">{head_role && head_role.name}</TableCell>
                          ...
                          <TableCell align="left">{data_access && data_access.name}</TableCell>
                          <TableCell align="left"><Checkbox checked={is_head===1} /></TableCell>                          
                        </TableRow>
                      );
                    })}
                  {emptyRows > 0 && (
