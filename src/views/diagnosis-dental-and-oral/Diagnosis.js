...
export default function Diagnosis() {
  ...
  //Fungsi GetData Diagnosis Dental And Oral
  const getData = async () => {
    const params = { ...filter };
  ...
  const showDeleteConfirmation = () => {
    ...
    setdialogContent(
      <DeleteConfirmation
        ...
        title="Diagnosis Dental And Oral"
      />
    );
  ...
  const handleDelete = async () => {
    ...
    const response = await axios.delete(endpoint.diagnosis_mcu.delete, {
      data: params,
    });
    if (response) {
