...
export default function RecapDiagnosis() {
  ...
  const getData = async () => {
    ...
    const response = await axios.get(
      endpoint.student_recap_diagnosis.root_recap_treatment,
      {
        params: params,
      }
    );
  ...
  const getExport = async (exportType) => {
    ...
    const response = await axios.get(
      endpoint.student_recap_diagnosis.export_treatment,
      {
        params: params,
      }
    );
  ...
  const downloadFile = async (
    url,
    student_treatment_recap_diagnosis,
    params
  ) => {
    await axios
      .get(url, {
      ...
      .then((rsp) => {
        ...
        link.href = url;
        link.setAttribute("download", "student_treatment_recap_diagnosis.xlsx"); //or any other extension
  ...
  return (
    <Page title="Student Treatment Report">
                  ...
                  .map((row) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">
                          {studenttreatmentgeneraldiagnosis.map(
                            (obj6, index) => {
                              return (
                                <List key={index}>
                                  <ListItem>
