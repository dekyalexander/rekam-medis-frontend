...
export default function DiagnosisDetail(props) {
  ...
  const submit = async () => {
    ...
    if (actionCode === "CREATE") {
      await axios.post(endpoint.diagnosis_eyes.create, params);
    } else {
      params = { ...params, id: state.id };
      await axios.put(endpoint.diagnosis_eyes.update, params);
    }
...
*/
  ...
  //     if (actionCode === "CREATE") {
  //       await axios.post(endpoint.diagnosis_eyes.create, values);
  //     } else {
  //       await axios.put(endpoint.diagnosis_eyes.update, values);
  //     }
  //     setSubmitting(false);
  //     submitSuccess("saving data success");
  //     getData();
    ...
    onSubmit: async (values, { setSubmitting }) => {
      if (actionCode === "CREATE") {
        let respon = await axios
          .post(endpoint.diagnosis_eyes.create, values)
        ...
        let respon = await axios
          .put(endpoint.diagnosis_eyes.update, values)
          .catch(function (error) {
