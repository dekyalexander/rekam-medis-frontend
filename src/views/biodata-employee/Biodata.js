...
const TABLE_HEAD = [
  ...
  { id: "handphone", label: "Handphone", alignRight: false },
...
export default function Biodata() {
  ...
  const getData = async (newPage, newRowsPerPage) => {
    ...
    const response = await axios.get(endpoint.employee.root, {
      params: params,
    });
  ...
  const handleDelete = async () => {
    ...
    const response = await axios.delete(endpoint.employee.delete, {
      data: params,
    });
    if (response) {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">
                        {employeecareer &&
                          employeecareer.employeeposition.employeeunit.name}
                      </TableCell>
                      <TableCell align="left">
                        {employeecontacts && employeecontacts.handphone}
                      </TableCell>
                      <TableCell align="left">
                        {employeecontacts && employeecontacts.telephone}
                      </TableCell>
                      <TableCell align="left">
                        {employeecontacts && employeecontacts.email}
                      </TableCell>
                      <TableCell align="left">
