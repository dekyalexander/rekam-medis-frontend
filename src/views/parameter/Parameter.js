...
import ParameterListHead from './ParameterListHead';
import ParameterListToolbar from './ParameterListToolbar';
...
export default function Parameter() {
  ...
  const getData = async () => {
    const response = await axios.get(endpoint.parameter.root);
  ...
  const handleDelete = async () => {
    ...
    const response = await axios.delete(endpoint.parameter.root, {
      data: params
    });
    if (response) {
