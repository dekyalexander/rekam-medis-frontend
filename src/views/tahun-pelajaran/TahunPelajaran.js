...
import TahunPelajaranListHead from './TahunPelajaranListHead';
import TahunPelajaranListToolbar from './TahunPelajaranListToolbar';
...
export default function TahunPelajaran() {
  ...
  const getData = async () => {
    const response = await axios.get(endpoint.tahun_pelajaran.root);
  ...
  const handleDelete = async () => {
    ...
    const response = await axios.delete(endpoint.tahun_pelajaran.root, {
      data: params
    });
    if (response) {
              ...
              <Table>
                ...
                <TableBody>
                  {filteredData
                    ...
                    .map((row) => {
                      const { id, name, code, is_active } = row;
