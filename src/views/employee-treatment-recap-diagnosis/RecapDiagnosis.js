...
export default function RecapDiagnosis() {
  ...
  const getData = async () => {
    ...
    const response = await axios.get(
      endpoint.employee_recap_diagnosis.root_recap_treatment,
      {
        params: params,
      }
    );
  ...
  const getExport = async (exportType) => {
    ...
    const params = {
      ...filter,
      unit: filter.unit,
      diagnosis_name: filter.diagnosis_name,
      inspection_date: filter.inspection_date,
      created_at: filter.created_at,
    };
    const response = await axios.get(
      endpoint.employee_recap_diagnosis.export_treatment,
      {
        params: params,
      }
    );
  ...
  const downloadFile = async (url, employee_recap_diagnosis, params) => {
    await axios
      .get(url, {
        params: params,
        responseType: "blob",
      ...
      .then((rsp) => {
        ...
        link.href = url;
        link.setAttribute("download", "employee_recap_diagnosis.xlsx"); //or any other extension
  ...
  return (
    <Page title="Employee Treatment Report">
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">
                          {employeeunit && employeeunit.name}
                        </TableCell>
                        <TableCell align="left">
