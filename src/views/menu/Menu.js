...
export default function Menu() {
  ...
  const getData = async () => {
    const params = { ...filter };
    const response = await axios.get(endpoint.menu.root, { params: params });
            ...
            <Table>
              ...
              <TableBody>
                {filteredData
                  ...
                  .map((row) => {
                    const { id, name,parent, path, application = {} } = row;
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="left">{parent && parent.name}</TableCell>
